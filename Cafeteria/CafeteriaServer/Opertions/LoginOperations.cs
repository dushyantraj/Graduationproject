...
public static class LoginOperations
{
    ...
    public static string LoginUser(MySqlConnection connection, UserCredentials credentials)
    {
        try
        {
            ...
            int roleId = userRepository.GetRoleId(connection, credentials);
            ...
            userRepository.LogUserActivity(connection, credentials.Username, LoginEventType);
    ...
    public static string LogoutUser(MySqlConnection connection, string username)
    {
        try
        {
            ...
            userRepository.LogUserActivity(connection, username, LogoutEventType);
